import { Candidate, Position, TestResult, FactorResult, Alert, PositionLevel } from '../types';
...
export const testCatalog = [{
  ...
  factors: ['Empuje/Iniciativa', 'Influencia/Persuasión', 'Estabilidad/Colaboración', 'Apego a Normas/Orden']
}, {
  id: 'IRV-20',
  name: 'Integridad, Responsabilidad y Valores',
  description: 'Evalúa integridad, responsabilidad, juicio ético y confiabilidad',
  items: 20,
  ...
  description: 'Evalúa autocontrol, tolerancia a presión y recuperación emocional',
  items: 20,
  format: 'Escala Likert 1-5',
  factors: ['Autocontrol', 'Tolerancia a Presión', 'Recuperación Emocional', 'Impulsividad']
}, {
  id: 'SCO-20',
  name: 'Servicio, Colaboración y Orientación al Cliente',
  description: 'Evalúa orientación al cliente, colaboración y empatía laboral',
  items: 20,
  format: 'Casos situacionales',
  factors: ['Orientación al Cliente', 'Colaboración', 'Comunicación Funcional', 'Empatía Laboral']
}, {
  id: 'RLP-18',
  ...
  factors: ['Lógica', 'Comprensión Verbal', 'Razonamiento Numérico', 'Análisis Práctico']
}, {
  id: 'LSD-16',
  ...
  items: 16,
  format: 'Casos situacionales',
  factors: ['Dirección', 'Delegación', 'Desarrollo de Personas', 'Seguimiento/Accountability']
}, {
  id: 'VMI-16',
  ...
  items: 16,
  format: 'Preferencias',
  factors: ['Logro', 'Estabilidad', 'Poder/Influencia', 'Servicio', 'Aprendizaje', 'Orden']
}, {
  id: 'CCO-12',
  ...
  factors: ['Seguimiento de Procedimientos', 'Atención al Detalle', 'Orden Documental', 'Conducta Preventiva']
}];
...
export const mockFactorResults: FactorResult[] = [{
  name: 'Empuje/Iniciativa',
  score: 85,
  level: 'very_high'
}, {
  name: 'Influencia/Persuasión',
  score: 78,
  level: 'high'
}, {
  name: 'Estabilidad/Colaboración',
  score: 82,
  level: 'very_high'
}, {
  name: 'Apego a Normas',
...
export const mockAlerts: Alert[] = [{
  ...
  type: 'warning',
  message: 'Considerar apoyo en gestión de estrés en periodos de alta demanda'
}];